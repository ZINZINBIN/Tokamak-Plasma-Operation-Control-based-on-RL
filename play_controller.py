...
def parsing():
    parser = argparse.ArgumentParser(description="Playing RL algorithms for tokamak plasma control")
...
if __name__ == "__main__":
    ...
    print("=========== RL algorithm control process ===========")
    print("Algorithm: {}".format(args['algorithm']))
    print("Objective: {}".format(args['objective']))
